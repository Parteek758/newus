...
import image2 from '../../Images/Owner.jpeg'
 const About = () => {
  return (
    <React.Fragment>
        ...
        <img alt="" sizes="(min-width: 1024px) 18rem, (min-width: 768px) 16rem, 11rem" height="576" decoding="async" data-nimg="future" className="absolute inset-0 h-full w-full object-cover" src={image2} />
        </div>
