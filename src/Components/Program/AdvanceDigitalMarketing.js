...
function AdvanceDigitalMarketing() {
  return (
    <Fragment>
    <section className={`${Program.fullstack} Digital`}>
        <div className={Program.fullstackwrapper}>
            <div className={Program.text}>
                ...
                Advance Digital Marketing</h1>
                <p className={`${Program.textp} mt-4 text-lg tracking-tight text-slate-700`}>Certificate in Advance Digital Marketing</p>
            </div>
...
<section className={Program.courseoutline}>
    <div className={Program.courseoutlinewrapper}>
        <div className={Program.courseheadding}>
            <h2 className='text-slate-900 font-extrabold tracking-tight'>Advance Digital Marketing</h2>
        </div>
        <div className={Program.coursecontant}>
            <div className={Program.contantitems}>
                <ul className={Program.unoderlist}>
                    ...
                    <li className={`${Program.listitems} text-blue-600`}> Social media marketing on all social media platforms such as facebook, Instagram etc.</li>
                    <li className={`${Program.listitems} text-blue-600`}> Creating blogs</li>
                    ...
                    <li className={`${Program.listitems} text-blue-600`}> Free hosting of website.</li>
                    <li className={`${Program.listitems} text-blue-600`}> Creating stunning advertising video using various videos editing tools.</li>
                    <li className={`${Program.listitems} text-blue-600`}> Graphic designing using various platforms.</li>
                </ul>
            </div>
        </div>
    </div>
...
export default AdvanceDigitalMarketing