...
import image from '../servies/Sevices/Training/images/Advanced-PHP-at-newus-Dharamsala.gif'
...
function AdvancePHP() {
  return (
    <Fragment>
    <section className={`${Program.fullstack} PHP`}>
        <div className={Program.fullstackwrapper}>
            <div className={Program.text}>
                ...
                <p className={`${Program.textp} mt-4 text-lg tracking-tight text-slate-700`}>Certificate in Advance Web Development using PHP</p>
            </div>
...
<section className={Program.courseoutline}>
  <div className={Program.courseoutlinewrapper}>
    <div className={Program.courseheadding}>
      <h2 className='text-slate-900 font-extrabold tracking-tight'>Advance PHP</h2>
    </div>
    <div className={Program.coursecontant}>
      ...
      <div className={Program.coursecontant}>
        <ul className={Program.unoderlist}>
            ...
            <li className={`${Program.listitems} text-blue-600`}>Core php</li>
            <li className={`${Program.listitems} text-blue-600`}>Advance php</li>
      ...
      <div className={Program.coursecontant}>
        ...
        <li className={`${Program.listitemmain} text-slate-900 font-extrabold tracking-tight`}>Web framework</li>
          <li className={`${Program.listitems} text-blue-600`}>Laravel Framework</li>
        </ul>
      </div>
    </div>
</div>
