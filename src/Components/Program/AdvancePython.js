...
function AdvancePython() {
    ...
    <section className={`${Program.fullstack} Python`}>
        <div className={Program.fullstackwrapper}>
            <div className={Program.text}>
                ...
                Advance Web Development using Python
                </h1>
                <p className={`${Program.textp} mt-4 text-lg tracking-tight text-slate-700`}>Certificate in Advance Web Development using Python</p>
            </div>
  ...
  <div className={Program.courseoutlinewrapper}>
    ...
    <div className={Program.coursecontant}>
      ...
      <div className={Program.coursecontant}>
        <ul className={Program.unoderlist}>
        <li className={`${Program.listitemmain} text-slate-900 font-extrabold tracking-tight`}>Framework</li>
          <li className={`${Program.listitems} text-blue-600`}>django Framework</li>
        </ul>
      </div>
    </div>
  </div>
