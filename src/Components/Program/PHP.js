...
function PHP() {
    ...
    <section className={`${Program.fullstack} PHP`}>
        <div className={Program.fullstackwrapper}>
            <div className={Program.text}>
                ...
                <p className={`${Program.textp} mt-4 text-lg tracking-tight text-slate-700`}>Certificate in Web Development using PHP</p>
            </div>
  ...
  <div className={Program.courseoutlinewrapper}>
    <div className={Program.courseheadding}>
      <h2 className='text-slate-900 font-extrabold tracking-tight'>PHP</h2>
    </div>
