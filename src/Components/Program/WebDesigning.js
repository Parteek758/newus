...
import image from '../servies/Sevices/Training/images/Web-Designing-at-newus-Dharamsala.gif'
...
function WebDesigning() {
  return (
    <Fragment>
    <section className={`${Program.fullstack} WebDesigning`}>
        <div className={Program.fullstackwrapper}>
            <div className={Program.text}>
                <h1 className={`${Program.texth1} 'mt- font-display font-extrabold tracking-tight '`}>
                Web Designing
                </h1>
                <p className={`${Program.textp} mt-4 text-lg tracking-tight text-slate-700`}>Certificate in WebDesigning</p>
            </div>
...
<section className={Program.courseoutline}>
  <div className={Program.courseoutlinewrapper}>
    <div className={Program.courseheadding}>
      <h2 className='text-slate-900 font-extrabold tracking-tight'>Web Designing</h2>
    </div>
    <div className={Program.coursecontant}>
      <div className={Program.contantitems}>
        <ul className={Program.unoderlist}>
        <li className={`${Program.listitems} text-blue-600`}>WEBSITE WITHOUT CODING</li>
